import{t as A}from"./index-CWSDBke7.js";import{u as E,a as I,g as V,c as k,o as z,r as l,K as r,L as M,e as m,f as g,j as n,k as i,l as o,t as u,i as e,p as j,n as D,au as G,a1 as $,D as H,B as N}from"./index-7NUCbB-L.js";import{M as X}from"./preview-B_f43va6.js";const J={class:"page-div"},O={class:"card-header"},F={style:{display:"flex"}},K={key:0},Q={class:"tip custom-block"},W={style:{"margin-top":"5px"}},Y={style:{"margin-top":"20px"}},Z={key:1,style:{height:"60vh"},class:"fcc"},ee=$({name:"toolsToken"}),re=Object.assign(ee,{setup(ne){const{t}=E();I();const v=V(),y=k(()=>v.language),f=k(()=>v.isDark);z(async()=>{});const s=l({expiredTime:null}),a=l(""),S=()=>{if(s.value.expiredTime===null){H(y.value==="zh"?"请选择过期时间":"Please select expire time");return}A.token.create.post(s.value).then(c=>{a.value=c.data,N(c.message)})},R=l(`\`\`\`python [id:Python]
import requests
...
`+C.value;return(c,p)=>{const d=r("el-option"),x=r("el-select"),_=r("el-button"),T=r("el-input"),B=r("el-result"),U=r("el-card"),P=M("copy");return m(),g("div",J,[n(U,{shadow:"never",style:{"min-height":"80vh"}},{header:i(()=>[o("div",O,[o("span",null,u(e(t)("tools.token.title")),1),o("div",F,[n(x,{modelValue:s.value.expiredTime,"onUpdate:modelValue":p[0]||(p[0]=h=>s.value.expiredTime=h),placeholder:e(t)("tools.token.expiredTime"),style:{width:"20vw","margin-right":"20px","font-weight":"lighter"}},{default:i(()=>[n(d,{label:e(t)("tools.token.options.day"),value:24},null,8,["label"]),n(d,{label:e(t)("tools.token.options.month"),value:720},null,8,["label"]),n(d,{label:e(t)("tools.token.options.year"),value:8760},null,8,["label"]),n(d,{label:e(t)("tools.token.options.forever"),value:8751240},null,8,["label"])]),_:1},8,["modelValue","placeholder"]),n(_,{type:"primary",onClick:S},{default:i(()=>[j(u(e(t)("tools.token.createButton")),1)]),_:1})])])]),default:i(()=>[o("div",null,[a.value?(m(),g("div",K,[o("div",Q,[o("div",W,u(e(t)("tools.token.tip.tip3")),1)]),n(T,{modelValue:a.value,"onUpdate:modelValue":p[1]||(p[1]=h=>a.value=h),style:{"max-width":"100%"}},{append:i(()=>[D(n(_,{icon:e(G)},null,8,["icon"]),[[P,a.value]])]),_:1},8,["modelValue"]),o("div",Y,[o("div",null,u(e(t)("tools.token.usage")),1),n(e(X),{modelValue:q,theme:f.value?"dark":"light",previewTheme:"github"},null,8,["theme"])])])):(m(),g("div",Z,[n(B,{title:e(t)("tools.token.tip.create"),icon:"info"},null,8,["title"])]))])]),_:1})])}}});export{re as default};
