import{u as b,a as D,g as S,c as B,o as M,r as h,B as r,C as q,d as v,e as g,f as n,w as p,i as e,t as o,j as t,m as c,ag as E,l as N,ah as Y,n as z,X as U,$ as j,y as A}from"./index-59SmMGpb.js";import{s as I}from"./index-Bo-qKgY6.js";const X={class:"page-div"},$={class:"card-header"},F={style:{display:"flex","align-items":"center"}},G={key:0},L={class:"tip custom-block"},O={style:{"font-weight":"bolder"}},R={style:{"margin-top":"5px"}},H={style:{"margin-top":"20px"}},J=U({name:"toolsToken"}),W=Object.assign(J,{setup(K){const{t:s}=b(),{isMobile:k}=D(),y=S(),f=B(()=>y.isDark);M(async()=>{l.value.expiredTime=new Date().getTime()});const l=h({expiredTime:0}),i=h(""),x=()=>{j.token.create.post(l.value).then(u=>{i.value=u.data,A(u.message)})},m=`import requests
