import{t as A}from"./index-C6Uy4rQt.js";import{u as E,a as I,g as V,c as k,o as z,r as l,K as r,L as M,f as m,i as g,k as n,l as i,m as o,t as u,j as e,q as j,p as D,ay as G,a1 as $,D as H,B as N}from"./index-DubB-sHn.js";import{M as X}from"./preview-CWimOESD.js";const J={class:"page-div"},O={class:"card-header"},F={style:{display:"flex"}},K={key:0},Q={class:"tip custom-block"},W={style:{"margin-top":"5px"}},Y={style:{"margin-top":"20px"}},Z={key:1,style:{height:"60vh"},class:"fcc"},ee=$({name:"toolsToken"}),re=Object.assign(ee,{setup(ne){const{t}=E();I();const v=V(),y=k(()=>v.language),f=k(()=>v.isDark);z(async()=>{});const s=l({expiredTime:null}),a=l(""),S=()=>{if(s.value.expiredTime===null){H(y.value==="zh"?"请选择过期时间":"Please select expire time");return}A.token.create.post(s.value).then(c=>{a.value=c.data,N(c.message)})},R=l(`\`\`\`python [id:Python]
import requests
