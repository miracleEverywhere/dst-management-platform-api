import{t as C}from"./index-CGO7SO4X.js";import{u as D,a as S,g as B,c as M,o as q,r as h,A as d,B as E,d as v,e as g,f as n,w as p,i as e,t as o,j as t,m as c,l as N,aa as Y,n as z,V as A,x as U}from"./index-Lmh5sJJi.js";import{t as j}from"./tools-BEjKDLTT.js";import{s as I}from"./index-VH09rHra.js";const F={class:"page-div"},G={class:"card-header"},L={style:{display:"flex","align-items":"center"}},O={key:0},R={class:"tip custom-block"},X={style:{"font-weight":"bolder"}},$={style:{"margin-top":"5px"}},H={style:{"margin-top":"20px"}},J=A({name:"toolsToken"}),ee=Object.assign(J,{setup(K){const{t:s}=D(),{isMobile:k}=S(),y=B(),f=M(()=>y.isDark);q(async()=>{l.value.expiredTime=new Date().getTime()});const l=h({expiredTime:0}),i=h(""),x=()=>{C.token.create.post(l.value).then(u=>{i.value=u.data,U(u.message)})},m=`import requests
