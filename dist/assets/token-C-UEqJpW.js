import{t as P}from"./index-B3PzdOJd.js";import{u as E,a as I,g as V,c as k,o as z,r as l,J as r,K as M,f as m,i as g,l as n,m as s,n as o,t as u,j as e,p as j,s as $,av as D,$ as G,A as H,B as N}from"./index-Dx2lUNdP.js";import{M as X}from"./preview-DjFbQ6Bf.js";const J={class:"page-div"},O={class:"card-header"},F={style:{display:"flex"}},K={key:0},Q={class:"tip custom-block"},W={style:{"margin-top":"5px"}},Y={style:{"margin-top":"20px"}},Z={key:1,style:{height:"60vh"},class:"fcc"},ee=G({name:"toolsToken"}),re=Object.assign(ee,{setup(ne){const{t}=E();I();const v=V(),y=k(()=>v.language),f=k(()=>v.isDark);z(async()=>{});const i=l({expiredTime:null}),a=l(""),S=()=>{if(i.value.expiredTime===null){H(y.value==="zh"?"请选择过期时间":"Please select expire time");return}P.token.create.post(i.value).then(c=>{a.value=c.data,N(c.message)})},R=l(`\`\`\`python [id:Python]
import requests
