...
永远可以在绚丽之门复活。",
  ...
  worldgen_id="DST_CAVE",
  worldgen_name="洞穴" 
}`},cn={class:"page-div"},mn={class:"el-form-item-msg"},pn={style:{"font-weight":"bolder"}},gn={class:"item-container"},hn={style:{"font-weight":"bolder"}},Tn={class:"item-container"},yn={style:{"font-weight":"bolder"}},_n={class:"item-container"},kn={style:{"font-weight":"bolder"}},Sn={class:"item-container"},bn={style:{"font-weight":"bolder"}},Ln={class:"item-container"},vn={style:{"font-weight":"bolder"}},En={class:"item-container"},Cn={style:{"font-weight":"bolder"}},wn={class:"item-container"},Vn={style:{"font-weight":"bolder"}},Fn={class:"item-container"},Bn={style:{"font-weight":"bolder"}},Gn={class:"item-container"},Rn={style:{"font-weight":"bolder"}},An={class:"item-container"},In={style:{"font-weight":"bolder"}},Nn={class:"item-container"},Un={style:{"font-weight":"bolder"}},Pn={class:"item-container"},Dn={style:{"font-weight":"bolder"}},$n={class:"item-container"},On={style:{"font-weight":"bolder"}},Mn={class:"item-container"},xn={style:{"margin-top":"10px"}},zn={style:{"font-weight":"bolder"}},qn={class:"item-container"},Wn={style:{"font-weight":"bolder"}},Kn={class:"item-container"},jn={style:{"font-weight":"bolder"}},Hn={class:"item-container"},Jn={style:{"font-weight":"bolder"}},Zn={class:"item-container"},Xn={style:{"font-weight":"bolder"}},Qn={class:"item-container"},Yn={style:{"font-weight":"bolder"}},el={class:"item-container"},tl={style:{"font-weight":"bolder"}},nl={class:"item-container"},ll={style:{"font-weight":"bolder"}},ol={class:"item-container"},al={style:{"font-weight":"bolder"}},il={class:"item-container"},rl={style:{display:"flex","justify-content":"flex-end"}},ul=sn({name:"settingsRoom"}),sl=Object.assign(ul,{setup(We){const{t:V}=ln();on(()=>{Me()});const de=Ae(!1),{isMobile:k}=an(),N=rn(),Ee=un(()=>N.isDark),ie=Ae(),me=Ae(),pe=Ae(0),Oe=o=>{pe.value>o&&(o===1&&Fe(),o===2&&$e(),pe.value=o)},Ke=()=>{pe.value===2&&Fe(),pe.value===3&&$e(),pe.value--},at=()=>{if(pe.value===0)lt.value.validate(o=>{if(o){if(X.value.masterPort===X.value.cavesPort){ht(V("setting.roomBaseFormRules.samePort"));return}Fe(),pe.value++}});else if(pe.value===1)Pe.value.validate(o=>{if(o)try{ot.parse(he.value.groundSetting),$e(),pe.value++}catch{ht(V("setting.luaError"))}});else if(pe.value===2)if(_e.value)try{ot.parse(_e.value.caveSetting),pe.value++}catch{ht(V("setting.luaError"))}else pe.value++;else if(pe.value===3)if(J.value)try{ot.parse(J.value.modSetting),pe.value++}catch{ht(V("setting.luaError"))}else pe.value++},lt=Ae(),X=Ae({name:"",description:"",gameMode:"",pvp:!1,playerNum:6,backDays:10,vote:!0,password:"",token:"",masterPort:0,cavesPort:0}),Ue={name:[{required:!0,message:V("setting.roomBaseFormRules.name"),trigger:"blur"}],masterPort:[{required:!0,message:V("setting.roomBaseFormRules.masterPort"),trigger:"blur"}],cavesPort:[{required:!0,message:V("setting.roomBaseFormRules.cavesPort"),trigger:"blur"}],gameMode:[{required:!0,message:V("setting.roomBaseFormRules.gameMode"),trigger:"change"}],token:[{required:!0,message:V("setting.roomBaseFormRules.token"),trigger:"blur"}]},Pe=Ae(),he=Ae({groundSetting:""}),ze={groundSetting:[{required:!0,message:V("setting.roomGroundFormRules.groundSetting"),trigger:"blur"}]},De=Ae(),_e=Ae({caveSetting:""}),qe={caveSetting:[{required:!0,message:V("setting.roomCaveFormRules.caveSetting"),trigger:"blur"}]},je=Ae(),J=Ae({modSetting:""}),te={modSetting:[{required:!0,message:V("setting.roomModFormRules.modSetting"),trigger:"blur"}]},Q=(o,i)=>{o==="master"&&(i==="endless"&&(he.value.groundSetting=$t.master),i==="survival"&&(he.value.groundSetting=Ot.master),Fe()),o==="caves"&&(i==="endless"&&(_e.value.caveSetting=$t.caves),i==="survival"&&(_e.value.caveSetting=Ot.caves),$e())},Me=()=>{Tt.room.get().then(o=>{X.value=o.data.base,he.value.groundSetting=o.data.ground,_e.value.caveSetting=o.data.cave,J.value.modSetting=o.data.mod})},et=o=>{switch(o){case"save":it();break;case"saveAndRestart":He();break;case"generateNewWorld":Je();break}},it=()=>{const o={base:X.value,ground:he.value.groundSetting,cave:_e.value.caveSetting,mod:J.value.modSetting};de.value=!0,Tt.save.post(o).then(i=>{Vt(i.message),de.value=!1}).finally(()=>{de.value=!1})},He=()=>{const o={base:X.value,ground:he.value.groundSetting,cave:_e.value.caveSetting,mod:J.value.modSetting};de.value=!0,Tt.saveAndRestart.post(o).then(i=>{Vt(i.message),de.value=!1}).finally(()=>{de.value=!1})},Je=()=>{const o={base:X.value,ground:he.value.groundSetting,cave:_e.value.caveSetting,mod:J.value.modSetting};de.value=!0,Tt.saveAndGenerate.post(o).then(i=>{de.value=!1,Vt(i.message)}).finally(()=>{de.value=!1})},tt=Ae("Code"),Y=Ae("Code"),D=Ae({}),Fe=()=>{if(he.value.groundSetting==="")return;const o=ot.parse(he.value.groundSetting),i=T(o);D.value=$(i)},$e=()=>{if(_e.value.caveSetting==="")return;const o=ot.parse(_e.value.caveSetting),i=T(o);D.value=$(i)};function T(o){const c=o.body[0].arguments[0];for(const g of c.fields)if(g.key.type==="Identifier"&&g.key.name==="overrides")return g.value;return null}function $(o){const i={};for(const c of o.fields){const g=c.key.name;i[g]=c.value.raw.replace(/"/g,"")}return i}const ce=o=>{const i=o.name,c=o.value,g=ot.parse(he.value.groundSetting),e=T(g);for(let p of e.fields)p.key.name===i&&(p.value.raw=`"${c}"`);const h=_(g);he.value.groundSetting=mt.Beautify(h,{RenameVariables:!1,RenameGlobals:!1,SolveMath:!1}),ie.value&&ie.value.refresh()},x=o=>{const i=o.name,c=o.value,g=ot.parse(_e.value.caveSetting),e=T(g);for(let p of e.fields)p.key.name===i&&(p.value.raw=`"${c}"`);const h=_(g);_e.value.caveSetting=mt.Beautify(h,{RenameVariables:!1,RenameGlobals:!1,SolveMath:!1}),me.value&&me.value.refresh()},_=(o,i=0)=>{const c="    ".repeat(i);switch(o.type){case"Chunk":return o.body.map(g=>_(g,i)).join(`
...
`+c)} }`;case"Field":return o.key?`${_(o.key)} = ${_(o.value)}`:_(o.value);case"AssignmentStatement":return`${c}${o.variables.map(_).join(", ")} = ${o.init.map(_).join(", ")}`;case"CallExpression":return`${_(o.base)}(${o.arguments.map(_).join(", ")})`;case"TableKeyString":return`${_(o.key)} = ${_(o.value)}`;case"BooleanLiteral":return o.raw;case"TableValue":return _(o.value);default:throw new Error(`Unsupported node type: ${o.type}`)}};return(o,i)=>{const c=ye("el-step"),g=ye("el-steps"),e=ye("el-card"),h=ye("el-col"),p=ye("el-row"),d=ye("el-input"),m=ye("el-form-item"),S=ye("el-tooltip"),t=ye("el-input-number"),l=ye("el-radio"),r=ye("el-radio-group"),s=ye("el-switch"),C=ye("el-slider"),ee=ye("el-link"),ne=ye("el-form"),ke=ye("el-button"),Ce=ye("el-tab-pane"),q=ye("el-divider"),O=ye("el-tabs"),j=ye("el-alert"),ge=ye("el-result"),st=ye("arrow-down"),Ze=ye("el-icon"),Ie=ye("el-dropdown-item"),xe=ye("el-dropdown-menu"),ft=ye("el-dropdown");return A(),Z("div",cn,[B(p,{gutter:10},{default:I(()=>[B(h,{lg:24,md:24,sm:24,span:24,xs:24,style:{"margin-top":"10px"}},{default:I(()=>[B(e,{shadow:"never"},{default:I(()=>[B(g,{active:pe.value,"align-center":"","finish-status":"success"},{default:I(()=>[B(c,{title:f(k)?o.$t("setting.roomSettingMobile"):o.$t("setting.roomSetting"),onClick:i[0]||(i[0]=u=>Oe(0))},null,8,["title"]),B(c,{title:f(k)?o.$t("setting.groundSettingMobile"):o.$t("setting.groundSetting"),onClick:i[1]||(i[1]=u=>Oe(1))},null,8,["title"]),B(c,{title:f(k)?o.$t("setting.caveSettingMobile"):o.$t("setting.caveSetting"),onClick:i[2]||(i[2]=u=>Oe(2))},null,8,["title"]),B(c,{title:f(k)?o.$t("setting.modSettingMobile"):o.$t("setting.modSetting"),onClick:i[3]||(i[3]=u=>Oe(3))},null,8,["title"]),B(c,{title:f(k)?o.$t("setting.finishSettingMobile"):o.$t("setting.finishSetting"),onClick:i[4]||(i[4]=u=>Oe(4))},null,8,["title"])]),_:1},8,["active"])]),_:1})]),_:1})]),_:1}),B(p,{gutter:10,style:{"margin-top":"5px"}},{default:I(()=>[B(h,{lg:24,md:24,sm:24,span:24,xs:24},{default:I(()=>[pe.value===0?(A(),le(e,{key:0,style:ut(f(k)?"min-height: 400px":"min-height: 600px"),shadow:"never"},{default:I(()=>[B(ne,{ref_key:"roomBaseFormRef",ref:lt,"label-position":f(k)?"top":"left","label-width":f(k)?"70":"auto",model:X.value,rules:Ue,size:f(k)?"small":"large"},{default:I(()=>[B(m,{label:f(V)("setting.baseForm.room"),prop:"name"},{default:I(()=>[B(d,{modelValue:X.value.name,"onUpdate:modelValue":i[5]||(i[5]=u=>X.value.name=u)},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.description"),prop:"description"},{default:I(()=>[B(d,{modelValue:X.value.description,"onUpdate:modelValue":i[6]||(i[6]=u=>X.value.description=u)},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{prop:"masterPort"},{label:I(()=>[B(S,{content:f(V)("setting.roomBaseFormPortToolTip"),effect:"light",placement:"top"},{default:I(()=>[oe(z(f(V)("setting.baseForm.masterPort")),1)]),_:1},8,["content"])]),default:I(()=>[B(t,{modelValue:X.value.masterPort,"onUpdate:modelValue":i[7]||(i[7]=u=>X.value.masterPort=u),max:65535,min:1,size:f(k)?"small":"large","controls-position":"right"},null,8,["modelValue","size"])]),_:1}),B(m,{prop:"cavesPort"},{label:I(()=>[B(S,{content:f(V)("setting.roomBaseFormPortToolTip"),effect:"light",placement:"top"},{default:I(()=>[oe(z(f(V)("setting.baseForm.cavesPort")),1)]),_:1},8,["content"])]),default:I(()=>[B(t,{modelValue:X.value.cavesPort,"onUpdate:modelValue":i[8]||(i[8]=u=>X.value.cavesPort=u),max:65535,min:1,size:f(k)?"small":"large","controls-position":"right"},null,8,["modelValue","size"])]),_:1}),B(m,{label:f(V)("setting.baseForm.gameMode.name"),prop:"gameMode"},{default:I(()=>[B(r,{modelValue:X.value.gameMode,"onUpdate:modelValue":i[9]||(i[9]=u=>X.value.gameMode=u)},{default:I(()=>[B(l,{label:o.$t("setting.baseForm.gameMode.endless"),value:"endless"},null,8,["label"]),B(l,{label:o.$t("setting.baseForm.gameMode.survival"),value:"survival"},null,8,["label"]),B(l,{label:o.$t("setting.baseForm.gameMode.lavaarena"),value:"lavaarena"},null,8,["label"]),B(l,{label:o.$t("setting.baseForm.gameMode.quagmire"),value:"quagmire"},null,8,["label"])]),_:1},8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.pvp"),prop:"pvp"},{default:I(()=>[B(s,{modelValue:X.value.pvp,"onUpdate:modelValue":i[10]||(i[10]=u=>X.value.pvp=u)},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.playerNum"),prop:"playerNum"},{default:I(()=>[B(C,{modelValue:X.value.playerNum,"onUpdate:modelValue":i[11]||(i[11]=u=>X.value.playerNum=u),max:100,min:2,"show-input":"",size:"small"},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.backDays"),prop:"backDays"},{default:I(()=>[B(C,{modelValue:X.value.backDays,"onUpdate:modelValue":i[12]||(i[12]=u=>X.value.backDays=u),max:50,min:5,"show-input":"",size:"small"},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.vote"),prop:"vote"},{default:I(()=>[B(s,{modelValue:X.value.vote,"onUpdate:modelValue":i[13]||(i[13]=u=>X.value.vote=u)},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.password")},{default:I(()=>[B(d,{modelValue:X.value.password,"onUpdate:modelValue":i[14]||(i[14]=u=>X.value.password=u)},null,8,["modelValue"])]),_:1},8,["label"]),B(m,{label:f(V)("setting.baseForm.token"),prop:"token"},{default:I(()=>[B(d,{modelValue:X.value.token,"onUpdate:modelValue":i[15]||(i[15]=u=>X.value.token=u),"show-password":""},null,8,["modelValue"]),K("div",mn,[B(ee,{underline:!1,href:"https://accounts.klei.com",target:"_blank"},{default:I(()=>[oe(z(f(V)("setting.baseForm.tokenHelp")),1)]),_:1})])]),_:1},8,["label"])]),_:1},8,["label-position","label-width","model","size"])]),_:1},8,["style"])):Ne("",!0),pe.value===1?(A(),le(e,{key:1,style:ut(f(k)?"min-height: 400px":"min-height: 600px"),shadow:"never"},{default:I(()=>[B(O,{modelValue:tt.value,"onUpdate:modelValue":i[19]||(i[19]=u=>tt.value=u)},{default:I(()=>[B(Ce,{label:f(V)("setting.tabCode"),name:"Code"},{default:I(()=>[X.value.gameMode==="endless"?(A(),le(ke,{key:0,type:"primary",onClick:i[16]||(i[16]=u=>Q("master","endless"))},{default:I(()=>[oe(z(f(V)("setting.luaImportButton.endless")),1)]),_:1})):Ne("",!0),X.value.gameMode==="survival"?(A(),le(ke,{key:1,type:"primary",onClick:i[17]||(i[17]=u=>Q("master","survival"))},{default:I(()=>[oe(z(f(V)("setting.luaImportButton.survival")),1)]),_:1})):Ne("",!0),B(ne,{ref_key:"roomGroundFormRef",ref:Pe,"label-width":f(k)?"70":"100",model:he.value,rules:ze,size:f(k)?"small":"large",style:{"margin-top":"10px"}},{default:I(()=>[B(m,{"label-position":"top",prop:"groundSetting"},{default:I(()=>[B(Ft,{ref_key:"editorGroundSettingRef",ref:ie,modelValue:he.value.groundSetting,"onUpdate:modelValue":i[18]||(i[18]=u=>he.value.groundSetting=u),height:f(k)?320:500,theme:Ee.value?"darcula":"idea",mode:"lua",style:{width:"100%"}},null,8,["modelValue","height","theme"])]),_:1})]),_:1},8,["label-width","model","size"])]),_:1},8,["label"]),(X.value.gameMode==="endless"||X.value.gameMode==="survival")&&he.value.groundSetting!==""?(A(),le(Ce,{key:0,label:f(V)("setting.tabVisualization"),name:"Visualization"},{default:I(()=>[B(q,{"content-position":"center"},{default:I(()=>[K("span",pn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.global")),1)]),_:1}),K("div",gn,[(A(!0),Z(be,null,Le(f(Ye).global,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",hn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.events")),1)]),_:1}),K("div",Tn,[(A(!0),Z(be,null,Le(f(Ye).events,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",yn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.survivors")),1)]),_:1}),K("div",_n,[(A(!0),Z(be,null,Le(f(Ye).survivors,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",kn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.world")),1)]),_:1}),K("div",Sn,[(A(!0),Z(be,null,Le(f(Ye).world,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",bn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.resourceRegrowth")),1)]),_:1}),K("div",Ln,[(A(!0),Z(be,null,Le(f(Ye).resourceRegrowth,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",vn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.unnaturalPortalResource")),1)]),_:1}),K("div",En,[(A(!0),Z(be,null,Le(f(Ye).unnaturalPortalResource,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Cn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.creatures")),1)]),_:1}),K("div",wn,[(A(!0),Z(be,null,Le(f(Ye).creatures,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Vn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.hostileCreatures")),1)]),_:1}),K("div",Fn,[(A(!0),Z(be,null,Le(f(Ye).hostileCreatures,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Bn,z(f(V)("setting.groundVisualizationRule")),1),oe(" - "+z(f(V)("setting.groundVisualizationRuleItem.giants")),1)]),_:1}),K("div",Gn,[(A(!0),Z(be,null,Le(f(Ye).giants,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Rn,z(f(V)("setting.groundVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.groundVisualizationGenerationItem.global")),1)]),_:1}),K("div",An,[(A(!0),Z(be,null,Le(f(dt).global,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",In,z(f(V)("setting.groundVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.groundVisualizationGenerationItem.world")),1)]),_:1}),K("div",Nn,[(A(!0),Z(be,null,Le(f(dt).world,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Un,z(f(V)("setting.groundVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.groundVisualizationGenerationItem.resources")),1)]),_:1}),K("div",Pn,[(A(!0),Z(be,null,Le(f(dt).resources,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Dn,z(f(V)("setting.groundVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.groundVisualizationGenerationItem.creaturesAndSpawners")),1)]),_:1}),K("div",$n,[(A(!0),Z(be,null,Le(f(dt).creaturesAndSpawners,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",On,z(f(V)("setting.groundVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.groundVisualizationGenerationItem.hostileCreaturesAndSpawners")),1)]),_:1}),K("div",Mn,[(A(!0),Z(be,null,Le(f(dt).hostileCreaturesAndSpawners,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:ce},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))])]),_:1},8,["label"])):Ne("",!0)]),_:1},8,["modelValue"])]),_:1},8,["style"])):Ne("",!0),pe.value===2?(A(),le(e,{key:2,style:ut(f(k)?"min-height: 400px":"min-height: 600px"),shadow:"never"},{default:I(()=>[B(O,{modelValue:Y.value,"onUpdate:modelValue":i[23]||(i[23]=u=>Y.value=u)},{default:I(()=>[B(Ce,{label:f(V)("setting.tabCode"),name:"Code"},{default:I(()=>[B(j,{closable:!1,effect:Ee.value?"light":"dark",type:"success"},{default:I(()=>[oe(z(f(V)("setting.cavesTip")),1)]),_:1},8,["effect"]),K("div",xn,[X.value.gameMode==="endless"?(A(),le(ke,{key:0,type:"primary",onClick:i[20]||(i[20]=u=>Q("caves","endless"))},{default:I(()=>[oe(z(f(V)("setting.luaImportButton.endless")),1)]),_:1})):Ne("",!0),X.value.gameMode==="survival"?(A(),le(ke,{key:1,type:"primary",onClick:i[21]||(i[21]=u=>Q("caves","survival"))},{default:I(()=>[oe(z(f(V)("setting.luaImportButton.survival")),1)]),_:1})):Ne("",!0)]),B(ne,{ref_key:"roomCaveFormRef",ref:De,"label-width":f(k)?"70":"100",model:_e.value,rules:qe,size:f(k)?"small":"large",style:{"margin-top":"10px"}},{default:I(()=>[B(m,{"label-position":"top",prop:"caveSetting"},{default:I(()=>[B(Ft,{ref_key:"editorCavesSettingRef",ref:me,modelValue:_e.value.caveSetting,"onUpdate:modelValue":i[22]||(i[22]=u=>_e.value.caveSetting=u),height:f(k)?320:500,theme:Ee.value?"darcula":"idea",mode:"lua",style:{width:"100%"}},null,8,["modelValue","height","theme"])]),_:1})]),_:1},8,["label-width","model","size"])]),_:1},8,["label"]),(X.value.gameMode==="endless"||X.value.gameMode==="survival")&&_e.value.caveSetting!==""?(A(),le(Ce,{key:0,label:f(V)("setting.tabVisualization"),name:"Visualization"},{default:I(()=>[B(q,{"content-position":"center"},{default:I(()=>[K("span",zn,z(f(V)("setting.cavesVisualizationRule")),1),oe(" - "+z(f(V)("setting.cavesVisualizationRuleItem.world")),1)]),_:1}),K("div",qn,[(A(!0),Z(be,null,Le(f(ct).world,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Wn,z(f(V)("setting.cavesVisualizationRule")),1),oe(" - "+z(f(V)("setting.cavesVisualizationRuleItem.resourceRegrowth")),1)]),_:1}),K("div",Kn,[(A(!0),Z(be,null,Le(f(ct).resourceRegrowth,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",jn,z(f(V)("setting.cavesVisualizationRule")),1),oe(" - "+z(f(V)("setting.cavesVisualizationRuleItem.creatures")),1)]),_:1}),K("div",Hn,[(A(!0),Z(be,null,Le(f(ct).creatures,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Jn,z(f(V)("setting.cavesVisualizationRule")),1),oe(" - "+z(f(V)("setting.cavesVisualizationRuleItem.hostileCreatures")),1)]),_:1}),K("div",Zn,[(A(!0),Z(be,null,Le(f(ct).hostileCreatures,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Xn,z(f(V)("setting.cavesVisualizationRule")),1),oe(" - "+z(f(V)("setting.cavesVisualizationRuleItem.giants")),1)]),_:1}),K("div",Qn,[(A(!0),Z(be,null,Le(f(ct).giants,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",Yn,z(f(V)("setting.cavesVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.cavesVisualizationGenerationItem.world")),1)]),_:1}),K("div",el,[(A(!0),Z(be,null,Le(f(yt).world,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(_t)[u].configs,customConfigsValue:f(_t)[u].customConfigsValue,i18n:f(_t)[u].i18n,image:f(_t)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",tl,z(f(V)("setting.cavesVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.cavesVisualizationGenerationItem.resources")),1)]),_:1}),K("div",nl,[(A(!0),Z(be,null,Le(f(yt).resources,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",ll,z(f(V)("setting.cavesVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.cavesVisualizationGenerationItem.creaturesAndSpawners")),1)]),_:1}),K("div",ol,[(A(!0),Z(be,null,Le(f(yt).creaturesAndSpawners,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))]),B(q,{"content-position":"center"},{default:I(()=>[K("span",al,z(f(V)("setting.cavesVisualizationGeneration")),1),oe(" - "+z(f(V)("setting.cavesVisualizationGenerationItem.hostileCreaturesAndSpawners")),1)]),_:1}),K("div",il,[(A(!0),Z(be,null,Le(f(yt).hostileCreaturesAndSpawners,u=>(A(),Z("div",null,[(A(),le(ve,{modelValue:D.value[u],"onUpdate:modelValue":H=>D.value[u]=H,configs:f(G)[u].configs,customConfigsValue:f(G)[u].customConfigsValue,i18n:f(G)[u].i18n,image:f(G)[u].image,name:u,key:new Date().getTime(),onChangeModelValue:x},null,8,["modelValue","onUpdate:modelValue","configs","customConfigsValue","i18n","image","name"]))]))),256))])]),_:1},8,["label"])):Ne("",!0)]),_:1},8,["modelValue"])]),_:1},8,["style"])):Ne("",!0),pe.value===3?(A(),le(e,{key:3,style:ut(f(k)?"min-height: 400px":"min-height: 600px"),shadow:"never"},{default:I(()=>[B(ne,{ref_key:"roomModFormRef",ref:je,"label-width":f(k)?"70":"100",model:J.value,rules:te,size:f(k)?"small":"large"},{default:I(()=>[B(m,{"label-position":"top",prop:"modSetting"},{default:I(()=>[B(Ft,{ref:"editor",modelValue:J.value.modSetting,"onUpdate:modelValue":i[24]||(i[24]=u=>J.value.modSetting=u),height:f(k)?320:500,theme:Ee.value?"darcula":"idea",mode:"lua",style:{width:"100%"}},null,8,["modelValue","height","theme"])]),_:1})]),_:1},8,["label-width","model","size"])]),_:1},8,["style"])):Ne("",!0),pe.value===4?(A(),le(e,{key:4,style:ut(f(k)?"min-height: 400px":"min-height: 600px"),shadow:"never"},{default:I(()=>[K("div",{style:ut(f(k)?"min-height: 360px":"min-height: 560px"),class:"fcc"},[B(ge,{"sub-title":o.$t("setting.finish.description"),title:o.$t("setting.finish.title"),icon:"success"},null,8,["sub-title","title"])],4)]),_:1},8,["style"])):Ne("",!0)]),_:1})]),_:1}),B(p,{gutter:10},{default:I(()=>[B(h,{lg:24,md:24,sm:24,span:24,xs:24},{default:I(()=>[B(e,{shadow:"never"},{default:I(()=>[K("div",rl,[pe.value>0?(A(),le(ke,{key:0,onClick:Ke},{default:I(()=>[oe(z(f(V)("setting.button.prev")),1)]),_:1})):Ne("",!0),pe.value<4?(A(),le(ke,{key:1,type:"primary",onClick:at},{default:I(()=>[oe(z(f(V)("setting.button.next")),1)]),_:1})):Ne("",!0),pe.value===4?(A(),le(ft,{key:2,style:{"margin-left":"12px"},trigger:"click",onCommand:et},{dropdown:I(()=>[B(xe,null,{default:I(()=>[B(Ie,{command:"save"},{default:I(()=>[oe(z(f(V)("setting.button.save")),1)]),_:1}),B(Ie,{command:"saveAndRestart"},{default:I(()=>[oe(z(f(V)("setting.button.saveAndRestart")),1)]),_:1}),B(Ie,{command:"generateNewWorld"},{default:I(()=>[oe(z(f(V)("setting.button.generateNewWorld")),1)]),_:1})]),_:1})]),default:I(()=>[B(ke,{loading:de.value,type:"warning"},{default:I(()=>[oe(z(f(V)("setting.button.actions"))+" ",1),B(Ze,{class:"el-icon--right"},{default:I(()=>[B(st)]),_:1})]),_:1},8,["loading"])]),_:1})):Ne("",!0)])]),_:1})]),_:1})]),_:1})])}}}),pl=nn(sl,[["__scopeId","data-v-70b76aaa"]]);export{pl as default};
