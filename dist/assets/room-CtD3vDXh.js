...
永远可以在绚丽之门复活。",
  ...
  worldgen_id="DST_CAVE",
  worldgen_name="洞穴" 
}`},yn={class:"page-div"},kn={class:"card-header"},bn={key:0},Sn={class:"el-form-item-msg"},Ln={class:"card-header"},vn={style:{display:"flex","flex-wrap":"wrap"}},Vn={style:{width:"99%"}},Cn={style:{width:"100%"}},En={style:{"font-weight":"bolder"}},wn={class:"item-container"},Fn={style:{"font-weight":"bolder"}},An={class:"item-container"},Bn={style:{"font-weight":"bolder"}},Mn={class:"item-container"},Gn={style:{"font-weight":"bolder"}},Rn={class:"item-container"},In={style:{"font-weight":"bolder"}},Pn={class:"item-container"},Un={style:{"font-weight":"bolder"}},xn={class:"item-container"},Nn={style:{"font-weight":"bolder"}},Dn={class:"item-container"},On={style:{"font-weight":"bolder"}},$n={class:"item-container"},Wn={style:{"font-weight":"bolder"}},zn={class:"item-container"},qn={style:{"font-weight":"bolder"}},Kn={class:"item-container"},jn={style:{"font-weight":"bolder"}},Hn={class:"item-container"},Jn={style:{"font-weight":"bolder"}},Yn={class:"item-container"},Zn={style:{"font-weight":"bolder"}},Xn={class:"item-container"},Qn={style:{"font-weight":"bolder"}},el={class:"item-container"},tl={style:{"font-weight":"bolder"}},nl={class:"item-container"},ll={style:{"font-weight":"bolder"}},al={class:"item-container"},ol={style:{"font-weight":"bolder"}},rl={class:"item-container"},il={style:{"font-weight":"bolder"}},ul={class:"item-container"},sl={style:{"font-weight":"bolder"}},dl={class:"item-container"},fl={style:{"font-weight":"bolder"}},cl={class:"item-container"},pl={style:{"font-weight":"bolder"}},ml={class:"item-container"},gl={style:{"font-weight":"bolder"}},hl={class:"item-container"},Tl={style:{"font-weight":"bolder"}},_l={class:"item-container"},yl={key:0,class:"tip_warning"},kl={style:{display:"flex","align-items":"center"}},bl={style:{display:"flex","justify-content":"flex-end"}},Sl={class:"tip_warning"},Ll={style:{margin:"50px"}},vl={style:{display:"flex","align-items":"center"}},Vl={style:{"margin-right":"10px"}},Cl={style:{display:"flex","justify-content":"flex-end","padding-top":"10px"}},El=hn({name:"settingsRoom"}),wl=Object.assign(El,{setup(Xe){const{t:V}=rn();un(async()=>{E.value=window.innerHeight,window.addEventListener("resize",()=>{E.value=window.innerHeight}),await te(),f()});const ge=Ae(!1),E=Ae(0),{isMobile:R}=sn(),Te=dn(),de=Ft(()=>Te.isDark),X=Ft(()=>Te.language),we=Ft(()=>{const s=(Te.dstClusters||[]).findIndex(P=>P.clusterName===Te.selectedDstCluster);return s!==-1?s:0}),Oe=fn();cn();const je=pn(),rt=mn("refresh"),ut=(a,s)=>{let P=null;return(...K)=>{P&&clearTimeout(P),P=setTimeout(()=>a(...K),s)}},$e=()=>{gt.clusters.get().then(a=>{Te.dstClusters=a.data,Te.selectedDstCluster===null&&Te.dstClusters!==null&&(Te.selectedDstCluster=Te.dstClusters[0].clusterName)})},Be=()=>{setTimeout(()=>{Oe.meta.isKeepAlive&&je.removeKeepAliveName(Oe.name),rt(!1),ct(()=>{Oe.meta.isKeepAlive&&je.addKeepAliveName(Oe.name),rt(!0)})},0)},_e=Ae(0),Fe=a=>{_e.value>a&&(_e.value=a)},He=()=>{_e.value--},Ue=async()=>{if(_e.value===0&&Je.value.validate(a=>{a&&_e.value++}),_e.value===1){for(let a in b)b!=null&&b.key&&await b[a].validate();for(let a of ee.value){if(a.levelData===""){it(X.value==="zh"?"请输入世界配置":"Please input world configure");return}if(a.shardMasterPort!==ee.value[0].shardMasterPort){it(X.value==="zh"?"主节点端口必须一致":"Master Port must be same");return}try{pt.parse(a.levelData)}catch{it(V("setting.luaError"));return}}_e.value++;return}if(_e.value===2)if(Y.value)try{pt.parse(Y.value.mod),_e.value++}catch{it(V("setting.luaError"))}else _e.value++},Je=Ae(),ae=Ae({clusterName:Te.selectedDstCluster,name:"",description:"",gameMode:"",pvp:!1,playerNum:6,backDays:10,vote:!1,password:"",token:""}),Qe={name:[{required:!0,message:V("setting.roomBaseFormRules.name"),trigger:"blur"}],masterPort:[{required:!0,message:V("setting.roomBaseFormRules.masterPort"),trigger:"blur"}],cavesPort:[{required:!0,message:V("setting.roomBaseFormRules.cavesPort"),trigger:"blur"}],gameMode:[{required:!0,message:V("setting.roomBaseFormRules.gameMode"),trigger:"change"}],token:[{required:!0,message:V("setting.roomBaseFormRules.token"),trigger:"blur"}]},Y=Ae({mod:""}),te=()=>{const a={clusterName:Te.selectedDstCluster};gt.cluster.get(a).then(s=>{if(ae.value=s.data.clusterSetting,s.data.worlds){ee.value=s.data.worlds;let P=1,K=999999;for(let ue of ee.value){let re=parseInt(ue.name.replace("World",""));re>P&&(P=re),re<K&&(K=re),ue.saved=!0}h.value=P,N.value="World"+K.toString()}else h.value=1,N.value="World1",ee.value=[{id:101,name:"World1",isMaster:!0,levelData:"",serverPort:11001+we.value*10,shardMasterPort:10888+we.value*10,steamMasterPort:27018+we.value*10,steamAuthenticationPort:8768+we.value*10,shardMasterIp:"127.0.0.1",clusterKey:"supersecretkey",encodeUserPath:!0,saved:!1}];Y.value.mod=s.data.mod})},ne=async a=>{switch(a){case"save":We();break;case"saveAndRestart":at();break;case"generateNewWorld":st();break}},We=()=>{const a={clusterSetting:ae.value,worlds:ee.value,mod:Y.value.mod,sysSetting:{}};ge.value=!0,gt.cluster.save.post(a).then(s=>{At(s.message),ge.value=!1,$e()}).finally(()=>{ge.value=!1,ct(()=>{Be()})})},at=()=>{const a={clusterSetting:ae.value,worlds:ee.value,mod:Y.value.mod,sysSetting:{}};ge.value=!0,gt.cluster.saveRestart.post(a).then(s=>{At(s.message),ge.value=!1,$e()}).finally(()=>{ge.value=!1,ct(()=>{Be()})})},st=()=>{const a={clusterSetting:ae.value,worlds:ee.value,mod:Y.value.mod,sysSetting:{}};ge.value=!0,gt.cluster.saveRegenerate.post(a).then(s=>{At(s.message),ge.value=!1,$e()}).finally(()=>{ge.value=!1,ct(()=>{Be()})})},H=Ae({}),et=a=>{if(a==="")return;const s=pt.parse(a),P=ot(s);H.value=Q(P)};function ot(a){const P=a.body[0].arguments[0];for(const K of P.fields)if(K.key.type==="Identifier"&&K.key.name==="overrides")return K.value;return null}function Q(a){const s={};for(const P of a.fields){const K=P.key.name;s[K]=P.value.raw.replace(/"/g,"")}return s}const ye=a=>{let s=Lt.Beautify(a,{RenameVariables:!1,RenameGlobals:!1,SolveMath:!1});return s=s.replace(/--\[\[\n\t.+\n\t.+\n--]]\n\n\n\n\n/g,""),s=s.replace(/ = /g,"="),s=s.replace(/\t/g,"  "),s=s.replace(/overrides=\{ +(.+)\n/g,`overrides={
    $1
`),s=s.replace(/^(\w+)=(.+)\n/gm,`    $1=$2
`),s=s.replace(/(.+)},\n/g,`$1
  },
`),s=s.replace(/^ +?\n/gm,""),s},oe=ut(a=>{const s=a.name,P=a.value;for(let K of ee.value)if(K.name===N.value){const ue=pt.parse(K.levelData),re=ot(ue);for(let Z of re.fields)Z.key.name===s&&(Z.value.raw=`"${P}"`);K.levelData=fe(ue);break}},100),fe=(a,s=0)=>{const P="    ".repeat(s);switch(a.type){case"Chunk":return a.body.map(K=>fe(K,s)).join(`
...
`+P)} }`;case"Field":return a.key?`${fe(a.key)} = ${fe(a.value)}`:fe(a.value);case"AssignmentStatement":return`${P}${a.variables.map(fe).join(", ")} = ${a.init.map(fe).join(", ")}`;case"CallExpression":return`${fe(a.base)}(${a.arguments.map(fe).join(", ")})`;case"TableKeyString":return`${fe(a.key)} = ${fe(a.value)}`;case"BooleanLiteral":return a.raw;case"TableKey":return`[${fe(a.key)}] = ${fe(a.value)}`;case"TableValue":return fe(a.value);default:throw new Error(`Unsupported node type: ${a.type}`)}},h=Ae(1),N=Ae("World1"),ee=Ae([{id:101,name:"World1",isMaster:!0,levelData:"",serverPort:11001+we.value*10,shardMasterPort:10888+we.value*10,steamMasterPort:27018+we.value*10,steamAuthenticationPort:8768+we.value*10,shardMasterIp:"127.0.0.1",clusterKey:"supersecretkey",encodeUserPath:!0}]),j={id:[{required:!0,message:V("setting.roomWorldFormRules.id"),trigger:"blur"}],isMaster:[{required:!0,trigger:"change"}],encodeUserPath:[{required:!0,trigger:"change"}],serverPort:[{required:!0,message:V("setting.roomWorldFormRules.masterPort"),trigger:"blur"}],shardMasterPort:[{required:!0,message:V("setting.roomWorldFormRules.shardMasterPort"),trigger:"blur"}],steamMasterPort:[{required:!0,message:V("setting.roomWorldFormRules.steamMasterPort"),trigger:"blur"}],steamAuthenticationPort:[{required:!0,message:V("setting.roomWorldFormRules.steamAuthenticationPort"),trigger:"blur"}],shardMasterIp:[{required:!0,message:V("setting.roomWorldFormRules.shardMasterIp"),trigger:"blur"}],clusterKey:[{required:!0,message:V("setting.roomWorldFormRules.clusterKey"),trigger:"blur"}]},b={},f=()=>{for(let a of ee.value){const s=ee.value.length;h.value=s,b[`World${s}`]=Ae()}},c=(a,s)=>{if(s==="add"){h.value++;const P=`World${h.value}`;b[P]=Ae(),ee.value.push({id:h.value+100,name:P,isMaster:!1,levelData:"",serverPort:11e3+h.value+we.value*10,shardMasterPort:10888+we.value*10,steamMasterPort:27017+h.value+we.value*10,steamAuthenticationPort:8767+h.value+we.value*10,shardMasterIp:"127.0.0.1",clusterKey:"supersecretkey",encodeUserPath:!0}),N.value=P}else if(s==="remove"){if(ee.value.length===1){it(X.value==="zh"?"每个房间至少含有一个世界":"Every room must include at least one world");return}const P=ee.value;let K=N.value;P.forEach((ue,re)=>{if(ue.name===a){const Z=P[re+1]||P[re-1];Z&&(K=Z.name)}}),N.value=K,ee.value=P.filter(ue=>ue.name!==a),delete b[a]}m.value="Code"},m=Ae("Code"),y=a=>{for(let s of ee.value)s.name===N.value&&(a.clusterType==="endless"&&(a.worldType==="ground"&&(s.levelData=$t.master),a.worldType==="cave"&&(s.levelData=$t.caves)),a.clusterType==="survival"&&(a.worldType==="ground"&&(s.levelData=Wt.master),a.worldType==="cave"&&(s.levelData=Wt.caves)))},e=Ae(""),T=async a=>{if(a==="Visualization")try{for(let s of ee.value)if(s.name===N.value){e.value=g(s.levelData),await et(s.levelData);break}}catch{it(X.value==="zh"?"可视化配置加载失败":"Visualization load failed")}a==="Code"&&await ct(()=>{for(let s of ee.value)if(s.name===N.value){s.levelData=ye(s.levelData);break}})},g=a=>{const s=/location\s*=\s*"([^"]*)"/,P=a.match(s);return P?P[1]:""},d=()=>{m.value="Code"},p=Ae(!1),S=Ae({}),t=Ae({}),o=()=>{S.value={},t.value={},p.value=!0},u=()=>{if(Object.keys(S.value).length!==ee.value.length){it(X.value==="zh"?"世界名为必填项":"World name is required");return}let a="";for(let re of ee.value)a=a+`["${re.id}"]="${S.value[re.id]}",`;let s="";for(let re of ee.value)s=s+`["${re.id}"]="${t.value[re.id]}",`;a=a.slice(0,-1),s=s.slice(0,-1);let P=`return {["workshop-1438233888"]={
