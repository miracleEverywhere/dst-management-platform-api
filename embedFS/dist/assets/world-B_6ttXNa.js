import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-DmnddWmG.js";import{C as CodeEditor}from"./CodeEditor-BRWlprSc.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-sfZQBuRu.js";import{_ as __unplugin_components_0}from"./ConfirmBox-slbqHY8F.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-B7bH8ktD.js";import{V as VMenu}from"./VMenu-mquMYW4h.js";import{V as VList}from"./VList-3hSKD0Lw.js";import{V as VForm}from"./VForm-DL-3iY43.js";import{V as VRow}from"./VRow-D3chgSJa.js";import{V as VCol}from"./VCol-C56MxxXt.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-D2mTfgeX.js";import{V as VChip}from"./VChip-DND22RJF.js";import{T as Tooltip}from"./index-CnJrSXd-.js";import{V as VTextField}from"./VTextField-ug6HhY55.js";import{V as VNumberInput}from"./VNumberInput-CUCq4o0y.js";import{V as VAlert}from"./VAlert-i5dBL0oP.js";import"./VSpacer-Bb4nsTy5.js";import"./VDialog-CGivDYwb.js";import"./dialog-transition-DdUt7k47.js";import"./ssrBoot-DdUZfYbR.js";import"./index-DhQA_3LI.js";import"./VInput-DexxZkqQ.js";import"./VSelectionControl-BFZL5f7U.js";import"./VTooltip-_5udR2ow.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
