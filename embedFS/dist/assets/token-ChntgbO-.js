import{Ar as e,Br as t,D as n,E as r,Fr as i,In as a,Jr as o,Kn as s,Nt as c,Or as l,Rn as u,T as d,Ur as f,V as p,Vr as m,_r as h,ei as g,fr as _,g as v,ii as y,kr as b,mr as x,ot as S,pr as C,ri as w,vr as T}from"./index-DX6aT22F.js";import{t as E}from"./VRow-ED8P4uE8.js";import{t as D}from"./VAlert-CFXNR38f.js";import{t as O}from"./preview-zjfuaHi3.js";import{t as k}from"./VSelect-DKGKtXG1.js";import{t as A}from"./VTextField-DbNMGM8m.js";import{t as j}from"./tools-KhJEENj0.js";var M={class:`card-header`},N=d({__name:`token`,setup(d){let{t:N}=n(),P=r(),F=_(()=>P.theme),I=_(()=>s(P.language)),L=o({expiration:void 0}),R=[{title:N(`tools.token.select.day`),value:24},{title:N(`tools.token.select.week`),value:168},{title:N(`tools.token.select.month`),value:720},{title:N(`tools.token.select.year`),value:365*24},{title:N(`tools.token.select.permanent`),value:0}];o(!1);let z=o(``),B=()=>{if(L.value.expiration===void 0){a(N(`tools.token.noSelected`),`error`);return}j.token.post(L.value).then(e=>{z.value=e.data,L.value.expiration=void 0,a(e.message,`success`)})},V=o(`\`\`\`python [id:Python]
import requests
