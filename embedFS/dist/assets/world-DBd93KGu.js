import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-CcamZvNC.js";import{C as CodeEditor}from"./CodeEditor-CHaA4G4m.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-BaVrkRAO.js";import{_ as __unplugin_components_0}from"./ConfirmBox-DgtIUz0m.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-B28h7uw8.js";import{V as VMenu}from"./VMenu-Br3R7AQo.js";import{V as VList}from"./VList-B-gAaKFR.js";import{V as VForm}from"./VForm-HpUJaEQp.js";import{V as VRow}from"./VRow-OoPZDP0Z.js";import{V as VCol}from"./VCol-DSzSLh_s.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-DbQu5-77.js";import{V as VChip}from"./VChip-SuoAXJ9A.js";import{T as Tooltip}from"./index-DGd1xWXS.js";import{V as VTextField}from"./VTextField-CEfNK0t-.js";import{V as VNumberInput}from"./VNumberInput--qOWJsAT.js";import{V as VAlert}from"./VAlert-WoCsK-IM.js";import"./VSpacer-BV2BQImc.js";import"./VDialog-BL7pjCEG.js";import"./dialog-transition-BnVaf8Wm.js";import"./ssrBoot-BfEiGav7.js";import"./index-x1LtRL1l.js";import"./VInput-BTJT1tcm.js";import"./VSelectionControl-DZtQEedG.js";import"./VTooltip-lTibJwwE.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
