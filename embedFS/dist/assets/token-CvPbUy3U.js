import{t as e}from"./VRow-CmFDrkmY.js";import{$r as t,B as n,Bn as r,Er as i,Hn as a,J as o,K as s,Lr as c,Rr as l,Tr as u,Un as d,Wr as f,Xr as p,Zn as m,Zr as h,_ as g,br as _,ii as v,mi as y,pi as b,ui as x,ur as S,xr as C,yr as w,z as T,zr as E}from"./index-GVipQhCH.js";import{t as D}from"./VAlert-B_K4-Ti-.js";import{t as O}from"./preview-BGZjpJ8Y.js";import{t as k}from"./VSelect-Dk73SfjH.js";import{t as A}from"./VTextField-4FUca12n.js";import{t as j}from"./tools-lx19mguX.js";var M={class:`card-header`},N=g({__name:`token`,setup(g){let{t:N}=S(),P=r(),F=w(()=>P.theme),I=w(()=>m(P.language)),L=v({expiration:void 0}),R=[{title:N(`tools.token.select.day`),value:24},{title:N(`tools.token.select.week`),value:168},{title:N(`tools.token.select.month`),value:720},{title:N(`tools.token.select.year`),value:365*24},{title:N(`tools.token.select.permanent`),value:0}];v(!1);let z=v(``),B=()=>{if(L.value.expiration===void 0){a(N(`tools.token.noSelected`),`error`);return}j.token.post(L.value).then(e=>{z.value=e.data,L.value.expiration=void 0,a(e.message,`success`)})},V=v(`\`\`\`python [id:Python]
