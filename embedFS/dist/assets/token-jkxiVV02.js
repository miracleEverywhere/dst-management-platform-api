import{$r as e,Br as t,D as n,Dr as r,E as i,Gn as a,Hr as o,In as s,Ln as c,Nt as l,Or as u,Pr as d,T as f,V as p,_r as m,dr as h,fr as g,g as _,gr as v,kr as y,ni as b,ot as x,pr as S,qr as C,ri as w,zr as T}from"./index-BI1_IBHB.js";import{t as E}from"./VRow-tbbXvSNt.js";import{t as D}from"./VAlert-7SOkiyba.js";import{t as O}from"./preview-647akpMi.js";import{t as k}from"./VSelect-CuZvgV2l.js";import{t as A}from"./VTextField-DUJm9ePn.js";import{t as j}from"./tools-aW5fv_9m.js";var M={class:`card-header`},N=f({__name:`token`,setup(f){let{t:N}=n(),P=i(),F=h(()=>P.theme),I=h(()=>a(P.language)),L=C({expiration:void 0}),R=[{title:N(`tools.token.select.day`),value:24},{title:N(`tools.token.select.week`),value:168},{title:N(`tools.token.select.month`),value:720},{title:N(`tools.token.select.year`),value:365*24},{title:N(`tools.token.select.permanent`),value:0}];C(!1);let z=C(``),B=()=>{if(L.value.expiration===void 0){s(N(`tools.token.noSelected`),`error`);return}j.token.post(L.value).then(e=>{z.value=e.data,L.value.expiration=void 0,s(e.message,`success`)})},V=C(`\`\`\`python [id:Python]
