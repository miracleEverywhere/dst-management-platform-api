import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-BapFOQPi.js";import{C as CodeEditor}from"./CodeEditor-DvgQ6UmI.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-BUnf2RnC.js";import{_ as __unplugin_components_0}from"./ConfirmBox-cT1r7cak.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-BaNV90Yg.js";import{V as VMenu}from"./VMenu-C6au4ilF.js";import{V as VList}from"./VList-C13HZqxx.js";import{V as VForm}from"./VForm-B8ZOmSsJ.js";import{V as VRow}from"./VRow-CGxaAGjt.js";import{V as VCol}from"./VCol-CQGQAEJR.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-Dr64su7p.js";import{V as VChip}from"./VChip-SJs7ZymH.js";import{T as Tooltip}from"./index-Bl9Dmpny.js";import{V as VTextField}from"./VTextField-Bbwm8ITv.js";import{V as VNumberInput}from"./VNumberInput-DyXMRBFy.js";import{V as VAlert}from"./VAlert-CaGAfd2T.js";import"./VSpacer-Xzl58V1j.js";import"./VDialog-8DrjMoe_.js";import"./dialog-transition-ButmKhHI.js";import"./ssrBoot-8Ec4ChwY.js";import"./index-ve5uCA-h.js";import"./VInput-CO-uI4gx.js";import"./VSelectionControl-Ct4Agezy.js";import"./VTooltip-qfSUCIe2.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
