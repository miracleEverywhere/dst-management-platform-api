import{t as e}from"./VRow-d6wLIBlH.js";import{B as t,Bn as n,Cr as r,Fr as i,Hn as a,Ir as o,J as s,K as c,Kr as l,Pr as u,Un as d,Vr as f,Yr as p,Zn as m,_ as h,br as g,ei as _,li as v,lr as y,oi as b,qr as x,ui as S,vr as C,wr as w,yr as T,z as E}from"./index-yRwSz3Tt.js";import{t as D}from"./VAlert-ybMBg8mM.js";import{t as O}from"./preview-BizTl5zM.js";import{t as k}from"./VSelect-BnKYM9X5.js";import{t as A}from"./VTextField-CMWncjYW.js";import{t as j}from"./tools-BRtbvYM-.js";var M={class:`card-header`},N=h({__name:`token`,setup(h){let{t:N}=y(),P=n(),F=C(()=>P.theme),I=C(()=>m(P.language)),L=_({expiration:void 0}),R=[{title:N(`tools.token.select.day`),value:24},{title:N(`tools.token.select.week`),value:168},{title:N(`tools.token.select.month`),value:720},{title:N(`tools.token.select.year`),value:365*24},{title:N(`tools.token.select.permanent`),value:0}];_(!1);let z=_(``),B=()=>{if(L.value.expiration===void 0){a(N(`tools.token.noSelected`),`error`);return}j.token.post(L.value).then(e=>{z.value=e.data,L.value.expiration=void 0,a(e.message,`success`)})},V=_(`\`\`\`python [id:Python]
