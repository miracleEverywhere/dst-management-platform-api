import{b as U,g as B,j as k,a2 as I,h as r,f as N,a3 as D,a4 as X,a5 as z,y as u,o as c,w as t,a as o,k as y,t as m,l as e,q as w,p as S,s as H,x as j,n as A,B as R}from"./index-dR3X8DmH.js";import{M as G}from"./preview-GGjyvgrL.js";import{t as O}from"./tools-CmRm6tVd.js";import{_ as $}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c as K,a as J,V as F}from"./VCard-DFyB8pZL.js";import{V as d}from"./VRow-BYOqVWdM.js";import{V as Q}from"./VAlert-BcAtxXA0.js";import{V as W}from"./VSelect-7y8VQfs4.js";import{V as Y}from"./VTextField-Do7k3axP.js";import"./axios-B15C4sn7.js";/* empty css              */import"./VInput-B205f9-L.js";import"./index-BblRTg5c.js";import"./VList-CD_-WmTF.js";import"./ssrBoot-DoAUzSEB.js";import"./VMenu-2WicHFBT.js";import"./dialog-transition-TuQ30WXj.js";import"./VCheckboxBtn-CtgjJ_dN.js";import"./VSelectionControl-BIz93f3W.js";import"./VChip-Bt9gA4cj.js";const Z={class:"card-header"},ee={__name:"token",setup(ne){const{t:n}=U(),g=B(),_=k(()=>g.theme),L=k(()=>I(g.language)),i=r({expiration:void 0}),V=[{title:n("tools.token.select.day"),value:24},{title:n("tools.token.select.week"),value:168},{title:n("tools.token.select.month"),value:720},{title:n("tools.token.select.year"),value:365*24},{title:n("tools.token.select.permanent"),value:0}];r(!1);const a=r(""),x=()=>{if(i.value.expiration===void 0){R(n("tools.token.noSelected"),"error");return}O.token.post(i.value).then(l=>{a.value=l.data,i.value.expiration=void 0,R(l.message,"success")})},C=r(`\`\`\`python [id:Python]
import requests
