import{_ as U,b as B,g as I,i as k,a6 as N,f as r,j as z,a7 as D,a8 as X,a9 as H,A as u,o as c,w as t,a as o,aa as A,k as y,t as m,l as e,p as G,v as w,s as S,x as j,z as O,n as $,V as K,G as R}from"./index-ClrSl1t3.js";import{M as J}from"./preview-aYiaw0yR.js";import{t as F}from"./tools-BPiMRB6c.js";import{V as d}from"./VRow-CbuO1l1g.js";import{V as Q}from"./VAlert-CWRnRAJx.js";import{V as W}from"./VSelect-HjFTEHVC.js";import{V as Y}from"./VTextField-C20ssUm5.js";import"./axios-DEwtRmaY.js";/* empty css              */import"./VInput-Dh0vzV9z.js";import"./index-rIMhUL3t.js";import"./VList-CRtGEhVV.js";import"./ssrBoot-4_sUra1R.js";import"./VMenu-DVaqAgsw.js";import"./dialog-transition-BOVVgIJg.js";import"./VCheckboxBtn-CD061qxM.js";import"./VSelectionControl-DRns-ek4.js";import"./VChip-DSSyFDgp.js";const Z={class:"card-header"},ee={__name:"token",setup(ne){const{t:n}=B(),g=I(),_=k(()=>g.theme),L=k(()=>N(g.language)),i=r({expiration:void 0}),V=[{title:n("tools.token.select.day"),value:24},{title:n("tools.token.select.week"),value:168},{title:n("tools.token.select.month"),value:720},{title:n("tools.token.select.year"),value:365*24},{title:n("tools.token.select.permanent"),value:0}];r(!1);const a=r(""),x=()=>{if(i.value.expiration===void 0){R(n("tools.token.noSelected"),"error");return}F.token.post(i.value).then(l=>{a.value=l.data,i.value.expiration=void 0,R(l.message,"success")})},C=r(`\`\`\`python [id:Python]
import requests
