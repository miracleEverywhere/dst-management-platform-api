import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-Djkhpkn3.js";import{C as CodeEditor}from"./CodeEditor-Dah3g7CR.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-DmiIai6s.js";import{_ as __unplugin_components_0}from"./ConfirmBox-Dp2D33km.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-D3lPURiY.js";import{V as VMenu}from"./VMenu-C9sgVsrD.js";import{V as VList}from"./VList-CQ4yaDex.js";import{V as VForm}from"./VForm-DMrDMqk_.js";import{V as VRow}from"./VRow-IMlBn_Zf.js";import{V as VCol}from"./VCol-DajDFdgW.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-CFQ6ITgw.js";import{V as VChip}from"./VChip-Cs3anucU.js";import{T as Tooltip}from"./index-D-1DcSaK.js";import{V as VTextField}from"./VTextField-CDymx_JI.js";import{V as VNumberInput}from"./VNumberInput-CJZdVmkq.js";import{V as VAlert}from"./VAlert-ijOc_GuP.js";import"./VSpacer-CBbJQ8Ee.js";import"./VDialog-DcNgxJHu.js";import"./dialog-transition-DmTVI0pL.js";import"./ssrBoot-BcBynsQ0.js";import"./index-BPd4TGS3.js";import"./VInput-DoTqixVt.js";import"./VSelectionControl-Cd0Eujz4.js";import"./VTooltip-B4E_WxoC.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
