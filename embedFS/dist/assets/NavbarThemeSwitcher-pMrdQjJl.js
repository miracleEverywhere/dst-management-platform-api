import{_ as B}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c as V,o as g,a as y,k as I,l as h,V as G,t as $,F as E,b as w,x as k,y as L,p as Q,Z as C,g as F,j as N,h as b,f as S,L as x,w as v,v as z,P as O,q as H,A as D,s as P,_ as A,$ as q,a0 as W,a1 as J,i as M}from"./index-DSqAz1aK.js";import{T}from"./index-V2kcKAJH.js";import{V as K}from"./VList-BEO0zeM6.js";import{V as U}from"./VMenu-D73OD9NE.js";const Y=(t="#8C57FF")=>{const e=`
...
`;return`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(e)}`},j={class:"font-weight-medium leading-normal text-xl text-uppercase"},X={__name:"NavHeader",setup(t){const e=Y();return(a,n)=>(g(),V(E,null,[y(G,{width:"3em",height:"2em",src:h(e)},null,8,["src"]),I("h1",j,$(a.$t("global.title")),1)],64))}},fe=B(X,[["__scopeId","data-v-ebb3b761"]]),he={__name:"Github",setup(t){const{t:e}=w();return(a,n)=>k((g(),L(Q,{icon:"ri-github-line",color:"default",variant:"text",href:"https://github.com/miracleEverywhere/dst-management-platform-api",target:"_blank",rel:"noopener noreferrer"},null,512)),[[T,h(e)("global.github")]])}},ge={__name:"LangSelect",setup(t){const e=w(),{current:a}=C(),n=F(),o=N(()=>n.language),r=b([]);S(()=>{c()});const c=()=>{n.language==="en"?r.value=[{label:"简体中文",value:"zh"},{label:"English",value:"en"}]:r.value=[{label:"简体中文",value:"zh"},{label:"English",value:"en"}]};x(()=>n.language,()=>{c()},{deep:!0});const m=l=>{switch(e.locale.value=l,n.language=l,l){case"zh":a.value="zhHans";break;case"en":a.value="en";break;default:a.value="zhHans"}};return(l,p)=>(g(),L(U,{"open-on-hover":""},{activator:v(({props:s})=>[y(Q,D({color:"default",icon:"ri-translate-2",variant:"text"},s),null,16)]),default:v(()=>[y(K,null,{default:v(()=>[(g(!0),V(E,null,z(h(r),s=>(g(),L(O,{key:s.value,command:s.value,disabled:h(o)===s.value,onClick:u=>m(s.value)},{default:v(()=>[H($(s.label),1)]),_:2},1032,["command","disabled","onClick"]))),128))]),_:1})]),_:1}))}},pe={__name:"Document",setup(t){const{t:e}=w();return(a,n)=>k((g(),L(Q,{icon:"ri-book-marked-line",color:"default",variant:"text",href:"https://miraclesses.top/",target:"_blank",rel:"noopener noreferrer"},null,512)),[[T,h(e)("global.document")]])}};function _(t){return typeof t=="function"?t():h(t)}typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const ee=()=>{};function te(t,e){function a(...n){return new Promise((o,r)=>{Promise.resolve(t(()=>e.apply(this,n),{fn:e,thisArg:this,args:n})).then(o).catch(r)})}return a}const Z=t=>t();function ae(t=Z){const e=b(!0);function a(){e.value=!1}function n(){e.value=!0}const o=(...r)=>{e.value&&t(...r)};return{isActive:A(e),pause:a,resume:n,eventFilter:o}}function ne(...t){if(t.length!==1)return q(...t);const e=t[0];return typeof e=="function"?A(W(()=>({get:e,set:ee}))):b(e)}function se(t,e,a={}){const{eventFilter:n=Z,...o}=a;return x(t,te(n,e),o)}function R(t,e,a={}){const{eventFilter:n,...o}=a,{eventFilter:r,pause:c,resume:m,isActive:l}=ae(n);return{stop:se(t,e,{...o,eventFilter:r}),pause:c,resume:m,isActive:l}}function de(t,e,...[a]){const{flush:n="sync",deep:o=!1,immediate:r=!0,direction:c="both",transform:m={}}=a||{},l=[],p="ltr"in m&&m.ltr||(i=>i),s="rtl"in m&&m.rtl||(i=>i);return(c==="both"||c==="ltr")&&l.push(R(t,i=>{l.forEach(f=>f.pause()),e.value=p(i),l.forEach(f=>f.resume())},{flush:n,deep:o,immediate:r})),(c==="both"||c==="rtl")&&l.push(R(e,i=>{l.forEach(f=>f.pause()),t.value=s(i),l.forEach(f=>f.resume())},{flush:n,deep:o,immediate:r})),()=>{l.forEach(i=>i.stop())}}function Le(t=!1,e={}){const{truthyValue:a=!0,falsyValue:n=!1}=e,o=P(t),r=b(t);function c(m){if(arguments.length)return r.value=m,r.value;{const l=_(a);return r.value=r.value===l?_(n):l,r.value}}return o?c:[r,c]}function re(t,e){const a=J(p()),n=ne(t),o=N({get(){var s;const u=n.value;let i=e?.getIndexOf?e.getIndexOf(a.value,u):u.indexOf(a.value);return i<0&&(i=(s=e?.fallbackIndex)!=null?s:0),i},set(s){r(s)}});function r(s){const u=n.value,i=u.length,f=(s%i+i)%i,d=u[f];return a.value=d,d}function c(s=1){return r(o.value+s)}function m(s=1){return c(s)}function l(s=1){return c(-s)}function p(){var s,u;return(u=_((s=e?.initialValue)!=null?s:_(t)[0]))!=null?u:void 0}return x(n,()=>r(o.value)),{state:a,index:o,next:m,prev:l,go:r}}const oe={__name:"ThemeSwitcher",props:{themes:{type:Array,required:!0}},setup(t){const e=t,a=F(),{t:n}=w(),{name:o,global:r}=M(),c=M(),{state:m,next:l,index:p}=re(e.themes.map(u=>u.name),{initialValue:a.theme});S(()=>{a.theme===""?a.theme=c.global.name.value:(c.change(a.theme),document.documentElement.className=a.theme)});const s=async u=>{const i=()=>{const d=l();c.change(d),a.theme=d,document.documentElement.className=d};if(!document.startViewTransition){i();return}await document.startViewTransition(i).ready,document.documentElement.animate({opacity:[0,1]},{duration:300,easing:"ease-in-out",pseudoElement:"::view-transition-new(root)"}),document.documentElement.animate({opacity:[1,0]},{duration:300,easing:"ease-in-out",pseudoElement:"::view-transition-old(root)"})};return x(()=>c.global.name.value,u=>{m.value=u}),(u,i)=>k((g(),L(Q,{icon:e.themes[h(p)].icon,color:"default",variant:"text",onClick:s},null,8,["icon"])),[[T,h(n)("global."+h(a).theme)]])}},ve={__name:"NavbarThemeSwitcher",setup(t){const e=[{name:"light",icon:"ri-sun-line"},{name:"dark",icon:"ri-moon-clear-line"}];return(a,n)=>{const o=oe;return g(),L(o,{themes:e})}}};export{fe as N,he as _,pe as a,ge as b,ve as c,de as s,Le as u};
