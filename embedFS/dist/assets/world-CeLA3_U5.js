import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-BZSGJZ_V.js";import{C as CodeEditor}from"./CodeEditor-ORRaNWex.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-DwDijqdE.js";import{_ as __unplugin_components_0}from"./ConfirmBox-Dg1xRBLK.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-BCBR688F.js";import{V as VMenu}from"./VMenu-BD9dgPdB.js";import{V as VList}from"./VList-DcCBbt53.js";import{V as VForm}from"./VForm-Ctc92HjU.js";import{V as VRow}from"./VRow-CJpsFvpy.js";import{V as VCol}from"./VCol-CsQ-Xed0.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-RlJq8nZu.js";import{V as VChip}from"./VChip-DxyRjM5W.js";import{T as Tooltip}from"./index-BKKtBdTV.js";import{V as VTextField}from"./VTextField-DHwardb5.js";import{V as VNumberInput}from"./VNumberInput-B93UeV5_.js";import{V as VAlert}from"./VAlert-C7yrujYW.js";import"./VSpacer-lzkCRhm8.js";import"./VDialog-SttzKXjI.js";import"./dialog-transition-Bb0rlYmD.js";import"./ssrBoot-BEWdK0X1.js";import"./index-msu0oUDo.js";import"./VInput-DuSHRzZw.js";import"./VSelectionControl-DY2mTuRY.js";import"./VTooltip-BFNjCCCJ.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
