import{aH as getDefaultExportFromCjs,_ as _export_sfc,e as useDisplay,b as useI18n,j as onMounted,f as ref,aE as GamePortFactor,O as watch,c as createElementBlock,o as openBlock,a as createVNode,w as withCtx,A as createBlock,D as createCommentVNode,F as Fragment,y as renderList,l as unref,v as createTextVNode,t as toDisplayString,s as VBtn,x as isRef,U as VListItem,E as mergeProps,z as withDirectives,J as VIcon,k as createBaseVNode,a8 as debounce,G as showSnackbar,aD as luaparse,aC as nextTick}from"./index-VLeM5oMz.js";import{C as CodeEditor}from"./CodeEditor-BhNLrBX-.js";import{g as groundWorldRule,_ as _sfc_main$1,o as overrides,a as groundWorldGeneration,c as cavesWorldRule,b as cavesWorldGeneration,d as caveOverrideWorldGenerationWorld}from"./levelDataSetting-D9750etA.js";import{_ as __unplugin_components_0}from"./ConfirmBox-iyfzLcLD.js";import{c as VTab,d as VTabs,e as VTabsWindowItem,f as VTabsWindow}from"./VTabs-BcuAmbUg.js";import{V as VMenu}from"./VMenu-BHoR6Skm.js";import{V as VList}from"./VList-BL2q1d3V.js";import{V as VForm}from"./VForm-BuTk4InN.js";import{V as VRow}from"./VRow-Bf5umvT1.js";import{V as VCol}from"./VCol-2EaLnh-v.js";import{V as VRadioGroup,a as VRadio}from"./VRadioGroup-CXib9j22.js";import{V as VChip}from"./VChip-CbozmnYj.js";import{T as Tooltip}from"./index-eLRP8v2W.js";import{V as VTextField}from"./VTextField-DPgQKV54.js";import{V as VNumberInput}from"./VNumberInput-DP2jacbw.js";import{V as VAlert}from"./VAlert-BAeYu9EA.js";import"./VSpacer-Ck2jBXK8.js";import"./VDialog-DKBkoj7Y.js";import"./dialog-transition-Cxov8jsJ.js";import"./ssrBoot-DSNIJrL7.js";import"./index-DVNosRie.js";import"./VInput-CX3T4pX0.js";import"./VSelectionControl-BRBqW1-w.js";import"./VTooltip-_XW2Y4y8.js";var src={},luamin$1={exports:{}},hasRequiredLuamin;function requireLuamin(){return hasRequiredLuamin||(hasRequiredLuamin=1,(function(y){function w(F){for(var h=0,d=F.length;d--;)h+=F.charCodeAt(d),h+=h<<10,h^=h>>6;return h+=h<<3,h^=h>>11,h+=h<<15,h}const S=console.log,n=function(F,h){if(!F)throw h};function C(F,h){if(!F)return 0;var d=F.toString().split(".");return d.length>1?parseInt(d[0],h)+parseInt(d[1],h)/Math.pow(h,d[1].length):parseInt(d[0],h)}let B=[" ",`
`,"	","\r"],Q={r:"\r",n:`
