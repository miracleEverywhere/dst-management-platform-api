import{t as e}from"./VRow-BC5oowXG.js";import{B as t,Bn as n,Hn as r,Ir as i,J as a,K as o,Lr as s,Qr as c,Rr as l,Tr as u,Un as d,Ur as f,Xr as p,Yr as m,Zn as h,_ as g,br as _,fi as v,li as y,lr as b,pi as x,ri as S,vr as C,wr as w,yr as T,z as E}from"./index-DMrKU-XX.js";import{t as D}from"./VAlert-qRY7h62O.js";import{t as O}from"./preview-B0_0lyfc.js";import{t as k}from"./VSelect-Ck20MxkI.js";import{t as A}from"./VTextField-CiMu7wj9.js";import{t as j}from"./tools-B1xOPi3K.js";var M={class:`card-header`},N=g({__name:`token`,setup(g){let{t:N}=b(),P=n(),F=C(()=>P.theme),I=C(()=>h(P.language)),L=S({expiration:void 0}),R=[{title:N(`tools.token.select.day`),value:24},{title:N(`tools.token.select.week`),value:168},{title:N(`tools.token.select.month`),value:720},{title:N(`tools.token.select.year`),value:365*24},{title:N(`tools.token.select.permanent`),value:0}];S(!1);let z=S(``),B=()=>{if(L.value.expiration===void 0){r(N(`tools.token.noSelected`),`error`);return}j.token.post(L.value).then(e=>{z.value=e.data,L.value.expiration=void 0,r(e.message,`success`)})},V=S(`\`\`\`python [id:Python]
